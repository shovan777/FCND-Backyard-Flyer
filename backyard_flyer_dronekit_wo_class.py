...
# register callbacks
add_attribute_listener('location.local_frame', local_location_callback)
add_attribute_listener('velocity', velocity_callback)
add_attribute_listener('armed', state_callback)
add_attribute_listener('mode', state_callback)
